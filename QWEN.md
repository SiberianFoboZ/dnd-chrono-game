...
> **Актуально по состоянию на 2026-08-22.** Миграция на Vue 3 + Vite + TypeScript + Tailwind **завершена** (включая Фазу 8 — перенос в корень). Последняя сессия — финализация дневника Эла (47 эпизодов, табличный layout).
